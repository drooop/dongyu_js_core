...
| 0325c-option-b-generator-rewrite | 2026-04-21 | 0325b 二次 sub-agent REJECT 后拆分：实装 Option B — 重写 server.mjs owner-materializer 生成器为 V1N.table 版本；迁移 workspace_positive_models.json legacy forward funcs；Bucket C handler 走 mt_write_req + shared root_routes；0325+0325b+0325c triple-merge | 7 | dev_0325c-option-b-generator-rewrite | Planned | ./docs/iterations/0325c-option-b-generator-rewrite/ |
