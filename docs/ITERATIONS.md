...
| 0304-slide-runtime-scope-semantics-freeze | 2026-04-09 | 冻结 Slide Runtime 新语义：分离 pin.table/pin.single 遗留清理与多重模型归属语义，并明确后续 IT 拆分 | 3 | dev_0304-slide-runtime-scope-semantics-freeze | Planned | ./docs/iterations/0304-slide-runtime-scope-semantics-freeze/ |
