...
| 0298-pin-contract-cleanup | 2026-04-06 | cleanup：清理非主路径上的 pin.table./pin.single./pin.model.* 历史残留，并同步更新规范文档 | 2 | dev_0298-pin-contract-cleanup | Approved | ./docs/iterations/0298-pin-contract-cleanup/ |
