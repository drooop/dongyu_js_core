...
| 0266-scoped-patch-authority | 2026-03-30 | 冻结并实施“全局 patch 仅限 bootstrap、运行态修改必须经当前模型 helper 执行 scoped patch”的权限模型，并升级所有受影响 JSON patches 后再部署验收 | 6 | dev_0266-scoped-patch-authority | In Progress | ./docs/iterations/0266-scoped-patch-authority/ |
