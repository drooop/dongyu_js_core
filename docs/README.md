...
本目录按“约束优先、执行次之、用户文档最后”组织。

## 1. 最高优先级

- `AGENTS.md`（仓库执行宪法，仓库根目录）
- `docs/architecture_mantanet_and_workers.md`（架构 SSOT）
- `docs/charters/*.md`（项目级 Charter）
...
- `docs/iterations/`：迭代合同与 runlog（事实记录，不做日常改写）
