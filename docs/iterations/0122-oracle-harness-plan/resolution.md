---
title: "Iteration 0122-oracle-harness-plan Resolution"
...
- Any real execution evidence must go to [[iterations/0122-oracle-harness-plan/runlog]] (NOT here).

## 1. Steps Overview

| Step | Title | Scope (Short) | Files (Key) | Validation (Executable) | Acceptance Criteria | Rollback |
|------|-------|---------------|-------------|--------------------------|--------------------|----------|
| 1    | Built-in k Discovery & Concrete Key Inventory | 定义发现协议并形成实际 key 清单 | [[iterations/0122-oracle-harness-plan/harness_plan]] | `rg -n "Concrete Key Inventory" docs/iterations/0122-oracle-harness-plan/harness_plan.md` | Inventory 完整且可追溯 | 删除新增文档 |
| 2    | Coverage Matrix & Harness Assertion Model | 按 key 组织覆盖矩阵与断言规则 | [[iterations/0122-oracle-harness-plan/harness_plan]] | `rg -n "Coverage Matrix" docs/iterations/0122-oracle-harness-plan/harness_plan.md` | 每个 key 有触发/副作用/证据等级/拦截点 | 回滚到仅含 Inventory 版本 |
