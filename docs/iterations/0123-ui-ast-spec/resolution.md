---
title: "Iteration 0123-ui-ast-spec Resolution"
...
- Any real execution evidence must go to [[iterations/0123-ui-ast-spec/runlog]] (NOT here).

## 1. Steps Overview

| Step | Title | Scope (Short) | Files (Key) | Validation (Executable) | Acceptance Criteria | Rollback |
|------|-------|---------------|-------------|--------------------------|--------------------|----------|
| 1    | UI AST Spec | 节点与字段规范 | [[iterations/0123-ui-ast-spec/spec]] | `rg -n "UI AST Spec" docs/iterations/0123-ui-ast-spec/spec.md` | AST 规范完整 | 删除新增文档 |
| 2    | Event & Render Contract | 事件归一化与渲染契约 | [[iterations/0123-ui-ast-spec/spec]] | `rg -n "Render Contract" docs/iterations/0123-ui-ast-spec/spec.md` | 契约完整且无语义冲突 | 回滚到 Step1 版本 |
