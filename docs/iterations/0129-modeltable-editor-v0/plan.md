---
title: "Iteration 0129-modeltable-editor-v0 Plan"
...
- Related:
  - [[WORKFLOW]]
  - [[ITERATIONS]]
  - [[architecture_mantanet_and_workers]]
  - [[ssot/runtime_semantics_modeltable_driven]]
  - [[charters/dongyu_app_next_runtime]]
  - [[roadmaps/dongyu-app-next-runtime]]
  - [[iterations/0123-ui-ast-spec/spec]]
  - [[iterations/0123-ui-renderer-impl/plan]]
  - [[iterations/0128-ui-line-demo-frontend/plan]]
...
- Phase 1 仅产出文档与计划：
  - [[iterations/0129-modeltable-editor-v0/plan]]
  - [[iterations/0129-modeltable-editor-v0/resolution]]
  - [[iterations/0129-modeltable-editor-v0/runlog]] (空模板)
  - [[ITERATIONS]] 登记为 Planned
...
- 迭代登记与记录：[[ITERATIONS]] 记录 Planned；runlog 记录 Review Gate（Phase2）。
...
- SSOT references:
  - [[architecture_mantanet_and_workers]] (ModelTable 真值、Sliding UI、UI 事件归一为写格子)
  - [[ssot/runtime_semantics_modeltable_driven]] (副作用由 add_label/rm_label 驱动)
- Notes:
...
- Charter references:
  - [[charters/dongyu_app_next_runtime]] (UI 只读 ModelTable；事件写格子；无双总线)
- Notes:
