---
title: "Iteration 0138-cell-owned-pin Resolution"
...
- Any real execution evidence must go to [[iterations/0138-cell-owned-pin/runlog]] (NOT here).

## 1. Steps Overview

| Step | Title | Scope (Short) | Files (Key) | Validation (Executable) | Acceptance Criteria | Rollback |
|------|-------|---------------|-------------|--------------------------|--------------------|----------|
| 1 | Define Cell-owned PIN contract | 明确 v schema 与兼容策略 | docs/iterations/0138-cell-owned-pin/*, [[user-guide/modeltable_user_guide]] | `rg -n "Cell-owned|PIN_IN|binding" docs/iterations/0138-cell-owned-pin docs/user-guide/modeltable_user_guide.md` | 文档可自洽，包含新旧兼容规则 | Revert Step 1 docs |
...
| 4 | Add/extend validation scripts | 新旧语义双轨验证并记录结果 | scripts/validate_pin_mqtt_loop.mjs, [[iterations/0138-cell-owned-pin/runlog]] | `node scripts/validate_pin_mqtt_loop.mjs` | 新旧 case 全部 PASS | Revert script changes |
...
**Files**
- Create/Update:
  - [[iterations/0138-cell-owned-pin/plan]]
  - [[iterations/0138-cell-owned-pin/resolution]]
  - [[user-guide/modeltable_user_guide]]
- Must NOT touch:
...
- Create/Update:
  ...
  - [[iterations/0138-cell-owned-pin/runlog]]
- Must NOT touch:
