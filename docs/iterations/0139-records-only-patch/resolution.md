...
|------|-------|---------------|-------------|--------------------------|--------------------|----------|
| 1    | Register + docs sync | Register iteration; align handover doc with runtime semantics | `docs/ITERATIONS.md`, `docs/handover/dam-worker-guide.md` | `git diff -- docs/ITERATIONS.md docs/handover/dam-worker-guide.md` | Iteration registered; docs state three-path semantics and trigger gating clearly | Revert doc changes |
...
- Commands:
  - `git diff -- docs/ITERATIONS.md docs/handover/dam-worker-guide.md`
- Expected signals:
