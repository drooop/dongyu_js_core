...
- Key outputs (snippets):
  - `__DY_PROTECTED_WL_0__:82:... pre-commit 自动门禁`
  - `__DY_PROTECTED_WL_1__:90:- git config core.hooksPath .githooks`
  - `__DY_PROTECTED_WL_2__:112:- skill 开始执行前 ... on`
- Result: PASS
...
- Commands executed:
  ...
  - `node scripts/fill_table_only_mode_ctl.mjs check --paths "__DY_PROTECTED_WL_3__,scripts/tests/test_0147_fill_table_only_auto_gate.mjs"`
...
- Key outputs (snippets):
  - `__DY_PROTECTED_WL_4__:<line>: | 0147-fill-table-only-auto-gate | ... | Completed | ... |`
- Result: PASS
