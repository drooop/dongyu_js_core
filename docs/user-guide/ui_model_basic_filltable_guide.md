...
| `id` | 新增；同一个临时模型内填 `0`。 |
| label 内部引用里的 `model_id` | 如果引用当前临时模型，填 `0`；安装器会 remap 成正式模型 id。 |
...
[
  ...
  { "op": "add_label", "model_id": 4100, "p": 2, "r": 2, "c": 1, "k": "ui_bind_json", "t": "json", "v": { "read": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "draft_text" }, "write": { "action": "ui_owner_label_update", "target_ref": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "draft_text" }, "commit_policy": "on_blur" } } },
  ...
  { "op": "add_label", "model_id": 4100, "p": 2, "r": 2, "c": 2, "k": "ui_bind_json", "t": "json", "v": { "write": { "action": "ui_owner_label_update", "target_ref": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "result_text" }, "value_ref": { "t": "str", "v": { "$label": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "draft_text" } } } } } },
  ...
  { "op": "add_label", "model_id": 4100, "p": 2, "r": 3, "c": 0, "k": "ui_bind_read_json", "t": "json", "v": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "result_text" } }
]
```
...
```json
{ "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "result_text" }
```
...
```json
{
  "read": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "draft_text" },
  "write": {
    "action": "ui_owner_label_update",
    "target_ref": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "draft_text" },
...
```json
{
  "write": {
    "action": "ui_owner_label_update",
    "target_ref": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "dialog_open" },
...
```json
{
  "write": {
    "action": "ui_owner_label_update",
    "target_ref": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "result_text" },
    "value_ref": {
      "t": "str",
      "v": {
        "$label": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "draft_text" }
      }
    }
  }
}
...
```json
{
  "write": {
    ...
    "value_ref": [
      ...
      { "id": 0, "p": 0, "r": 0, "c": 0, "k": "input_text", "t": "str", "v": { "$label": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "draft_text" } } }
    ],
    "meta": {
...
[
  ...
  { "op": "add_label", "model_id": 4100, "p": 2, "r": 5, "c": 0, "k": "ui_bind_json", "t": "json", "v": { "read": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "dialog_open" }, "write": { "action": "ui_owner_label_update", "target_ref": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "dialog_open" } } } }
]
```
...
[
  ...
  { "op": "add_label", "model_id": 4100, "p": 2, "r": 6, "c": 0, "k": "ui_bind_json", "t": "json", "v": { "read": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "active_tab" }, "write": { "action": "ui_owner_label_update", "target_ref": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "active_tab" } } } },
...
```json
{
  "hiddenRef": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "show_detail" }
}
```
...
```json
{
  "visibleRef": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "show_detail" }
}
```
...
```json
{
  "write": {
    "action": "ui_owner_label_update",
    "target_ref": { "model_id": 4100, "p": 0, "r": 0, "c": 0, "k": "show_detail" },
    "value_ref": { "t": "bool", "v": true }
  }
}
```
