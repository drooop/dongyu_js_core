...
role_files = {
    ...
    'remote-worker': [
        ...
        ('deploy/sys-v1ns/remote-worker/patches/15_model3200_feishu_message_api.json', 'roles/remote-worker/patches/15_model3200_feishu_message_api.json', '40-role-positive'),
    ],
    'workspace-manager': [
