  ...
  return buildBasePayload(
    ...
    [
      ...
      { id: 0, p: 0, r: 0, c: 0, k: 'handle_submit', t: 'func.js', v: { code: [
        ...
        "];",
        "const records = [",
        "  { op: 'add_label', model_id: ctx.self.model_id, p: 0, r: 0, c: 0, k: 'input_text', t: 'str', v: text },",
        "  { op: 'add_label', model_id: ctx.self.model_id, p: 0, r: 0, c: 0, k: 'last_submit_payload', t: 'json', v: payload },",
        "  { op: 'add_label', model_id: ctx.self.model_id, p: 0, r: 0, c: 0, k: 'status_text', t: 'str', v: text ? 'payload_ready' : 'empty_input' }",
        "];",
